namespace de.patrickkreft.cfe.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5000/";
    public readonly static string iOSAppName = "de.patrickkreft.cfe";
    public readonly static string AndroidAppName = "de.patrickkreft.cfe";
